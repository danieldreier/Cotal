...
export class MeshAgent extends EventEmitter {
  ...
  async spawn(name: string, role?: string, opts?: { agent?: string; model?: string; variant?: string; launchOptions?: Record<string, unknown>; cwd?: string; task?: string }): Promise<ControlReply> {
    this.assertConnected();
    const args = {
