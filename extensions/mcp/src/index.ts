...
const command: Command = {
  ...
  flags: [
    ...
    { name: "cpn", type: "boolean", description: "use the CPN Kubernetes laptop enrollment and loopback-tunnel contract" },
    { name: "principal", type: "string", value: "<label>", description: "CPN identity label prefix; every gateway identity remains fresh" },
    { name: "role", type: "string", value: "<leader|helper>", description: "CPN laptop role (default: leader)" },
